...
def draw(win, grid, buttons, imageManager, isImage):
    ...
    if isImage:                               # checks if there is a change in the image
        ImgMan.render(ImgMan,WIN,grid)        # renders the image
...
buttons.append(Button(rtb_x - size_large/2 + 50, 5, size_small, size_medium, color=(150,150,150), text='', name = "GS"))                                                               # Greyscale the Image
buttons.append(Button(rtb_x - size_large/2 + 50 + size_small, 5, size_small, size_medium, color=(250,20,20), text='', name = "Red"))                                                   # Apply Red Filter
buttons.append(Button(rtb_x - size_large/2 + 50 + size_small*2, 5, size_small, size_medium, color=(20,250,20), text='', name = "Green"))                                               # Apply Green Filter
buttons.append(Button(rtb_x - size_large/2 + 50 + size_small*3, 5, size_small, size_medium, color=(20,20,250), text='', name = "Blue"))                                                # Apply Blue Filter
buttons.append(Button(rtb_x - size_large / 2 + 50, 50, size_large, size_large, color=(150, 200, 100), text='ROT', name = "rotate"))                                                    # Rotate the Image 90 degrees
buttons.append(Button(rtb_x - size_large / 2 + 50, 50 + size_large, size_large, size_large, color=(150, 200, 100), text='H flip', name = "H flip"))                                    # Horizontally Flip the Image
buttons.append(Button(rtb_x - size_large / 2 + 50, 50 + size_large*2, size_large, size_large, color=(150, 200, 100), text='V flip', name = "V flip"))                                  # Vertically Flip the Image
buttons.append(Button(rtb_x - size_large / 2 + 50, 50 + size_large*3, size_small, size_large, color=(150, 200, 100), text='L', name = "MLeft"))                                        # Move the Image 1 step to the Left
buttons.append(Button(rtb_x - size_large / 2 + 50 + size_small*3, 50 + size_large*3, size_small, size_large, color=(150, 200, 100), text='R', name = "MRight"))                        # Move the Image 1 step to the Right
buttons.append(Button(rtb_x - size_large / 2 + 50 + size_small, 50 + size_large*3, size_large, size_small, color=(150, 200, 100), text='MU', name = "MUp"))                            # Move the Image 1 step Upwards
buttons.append(Button(rtb_x - size_large / 2 + 50 + size_small, 50 + size_large*3 + size_small, size_large, size_small, color=(150, 200, 100), text='MD', name = "MDown"))             # Move the Image 1 step Downwards
buttons.append(Button(rtb_x - size_large / 2 + 50, 50 + size_large*4, size_large, size_large, color=(150, 200, 100), text='HU', name = "HUp"))                                         # Increase the Height by 1
buttons.append(Button(rtb_x - size_large / 2 + 50, 50 + size_large*5, size_large, size_large, color=(150, 200, 100), text='HD', name = "HDown"))                                       # Decrease the Height by 1
buttons.append(Button(rtb_x - size_large / 2 + 50, 50 + size_large*6, size_large, size_large, color=(150, 200, 100), text='WU', name = "WUp"))                                         # Increase the Width by 1
buttons.append(Button(rtb_x - size_large / 2 + 50, 50 + size_large*7, size_large, size_large, color=(150, 200, 100), text='WD', name = "WDown"))                                       # Decrease the Width by 1
buttons.append(Button(rtb_x - size_large / 2 + 50, 50 + size_large*8, size_large, size_large, color=(200, 0, 0), text='X', name = "remove"))                                           # Remove the image
buttons.append(Button(rtb_x - size_large / 2 + 50, 50 + size_large*9, size_large, size_large, color=(100, 100, 250), text='Load', name = "upload"))                                    # Load a Image
buttons.append(Button(rtb_x - size_large / 2 + 50, 50 + size_large*10, size_large, size_large, color=(100, 100, 250), text='QSave', name = "QSave"))                                   # Quick Screenshot of the Grid
buttons.append(Button(rtb_x - size_large / 2 + 50, 50 + size_large*11, size_large, size_large, color=(100, 100, 250), text='Save', name = "SaveAs"))                                   # Screenshot of the Grid
...
while run:
    ...
    for event in pygame.event.get():
        ...
        if not text:
            draw(WIN, grid, buttons, ImgMan, isImage)                                    #modified draw, it now checks if there is a change in the image and then renders it
